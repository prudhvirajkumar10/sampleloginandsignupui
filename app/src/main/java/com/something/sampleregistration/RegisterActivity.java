...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_email = (TextInputEditText) findViewById(R.id.registerEmail);
        et_password = (TextInputEditText) findViewById(R.id.registerPassword);
        et_cpassword = (TextInputEditText) findViewById(R.id.registerConfirmPassword);
        et_phone = (TextInputEditText) findViewById(R.id.registerPhone);
        et_name = (TextInputEditText) findViewById(R.id.registerName);
